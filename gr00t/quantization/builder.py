...
def build_holoq_pack(
    ...
    *,
    ...
    manifest = {
        ...
        "native_activation_quantization": "fused-cuda-dynamic-per-token",
        "native_activation_packing": "fused-cuda-signed-int4",
        "native_output_epilogue": "fused-cuda-scale-bias-cast",
        "native_silent_fallback": False,
